  ...
  var MENU = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "kapucinoftohte", name: "Kapuçino i Ftohtë", sub: "Espresso & Akull", price: 180, rating: 4.6, icon: "coffee", colors: ["#b58a5c"], desc: "Kapuçino i shkumëzuar, i shërbyer i ftohtë mbi akull. Kremoz dhe freskues, ideal për ditët e nxehta." },
